  ...
  <form class="form-inline" role="form" method="post" action="">
    ...
    <button type="submit" name="submit" class="btn btn-success">Tampilkan</button>
              ...
              <div class="modal-body" id="cetak_report">
                ...
                <center><H3> LAPORAN PEMERIKSAAN RADIOLOGI <br> RS MUJI RAHAYU </H3></center>
                ...
                $no = 1;
                  if(isset($_REQUEST['submit'])){
                   ...
                   $tgl1 = $_REQUEST['tgl1'];
                   $tgl2 = $_REQUEST['tgl2'];
                      $select = mysqli_query($konek, "SELECT * FROM v_photo WHERE tanggal BETWEEN '$tgl1' AND '$tgl2'");

                        }else {
                           $select = mysqli_query($konek,"SELECT * FROM v_photo");
                           }
