      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <a href="beranda.php?page=dGFtcGlscmFkaW9sb2dpZGVsaXM=">     <button type="submit" class="btn btn-primary">KEMBALI</button></a>
                <H4>Keterangan </H4> 
        ...
        <div class="col-md-9">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Tanggal : <?php echo $data['tanggal'];?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
