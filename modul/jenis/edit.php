...
$sqlku = mysqli_query($konek,"SELECT * FROM tbl_jenis WHERE uraian='$id'");
...
<div class="col-md-12">    
    ...
    <?php
          if (isset($_POST["btnedit"])){
            ...
            $edit = mysqli_query($konek,"UPDATE  tbl_jenis SET uraian='$txturaian' WHERE uraian='$id'");
            if ($edit)
            {
              ?>
        ...
        echo "<meta http-equiv='refresh' content='0; url=?page=edit_jenis'>";
            }
          }
        ?>
          </div>
