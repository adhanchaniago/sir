  <?php
  error_reporting(0); 
  $carikode = mysqli_query($konek, "select max(kode) from tbl_satuan") or die (mysql_error());
                     ...
                     <?php
                              if (isset($_POST["btnsimpan"])){
                                ...
                                $txtkode =$_POST['txtkode'];
                                  $simpan = mysqli_query($konek,"INSERT INTO tbl_satuan (kode,uraian) VALUES ('$txtkode','$txturaian')");
                                if ($simpan){
                                  ?>
                                  <script type="text/javascript">
                                    document.location.href="beranda.php?page=satuan";
                                  </script>
                                  <?php
                                }else{
            ...
            <div class="box-header with-border">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                            $no =1;
                              $qry = mysqli_query($konek,"SELECT * FROM tbl_satuan order by uraian asc");
                    ...
                    <tr>
                       ...
                       <td> <a href="beranda.php?page=edit_satuan&id=<?php echo base64_encode($data['uraian']); ?>" class="fa fa-edit">Edit</a></td>
                       <td> <a onClick="return confirm('Yakin Anda Menghapus ?')" href="beranda.php?page=satuan&hapus=<?php echo $data['kode']; ?>" class="fa fa-eraser">Hapus</a></td>
                    </tr>
                  <?php } ?>
                  </tfoot>
              </table>
