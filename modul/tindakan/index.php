          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">MASTER TINDAKAN RADIOLGI</h4>
              </div>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="uraian" name="txttindakan" placeholder="Nama Tindakan"  required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="uraian" name="txtjumlah" placeholder="Harga / Tindakan" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                  </div>
                </div>
                     ...
                     <?php
                              if (isset($_POST["btnsimpan"])){
                                $txtkode =$_POST['txtkode'];
                                  ...
                                  $simpan = mysqli_query($konek,"INSERT INTO tbl_tindakan (kode,uraian,harga) VALUES ('$txtkode','$txttindakan','$txtjumlah')");
                                if ($simpan){
                                  ?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <a class="btn btn-app"  data-toggle="modal" data-target="#modal-default">
                <i class="fa fa-edit"></i>Add Tindakan
              </a>
               <br>
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    <tr>
                       ...
                       <td> <a href="beranda.php?page=edit_tindakan&id=<?php echo base64_encode($data['kode']); ?>" class="fa fa-edit">Edit</a>
